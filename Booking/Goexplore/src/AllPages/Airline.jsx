  ...
  export default function Home() {
    ...
    useEffect(() => {
      const fetchData = async () => {
          try {
              const res = await fetch("http://localhost:9090/Flights/flights");
              const data1 = await res.json();
              setProductData(data1.fligths);
          } catch (error) {
    ...
    return (
      <div className="w-full">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('https://s28477.pcdn.co/wp-content/uploads/2017/07/singapore_airlines_A380.jpg')",
          }}
        >
        ...
        <main className="px-4 md:px-6 lg:px-8 mt-5">
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-8">
            ...
            <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm">
              <a href="#">
                <img className="rounded-t-lg" src="https://r-xx.bstatic.com/xdata/images/city/608x352/619666.webp?k=504b97635641d489438feb63780d4ae80ce8a2fd08a1fcb6183485738a87e6ad&o=" alt="Travel" />
              </a>
              <div className="p-5">
                <a href="#">
